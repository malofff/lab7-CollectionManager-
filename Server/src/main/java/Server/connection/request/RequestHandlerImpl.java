...
public class RequestHandlerImpl implements RequestHandler {
    ...
    private Response handleExecuteRequest(Request request) throws CommandIsNotExistException {
        ...
        commandReader.executeCommand(addingString, collectionManager.getServerHumanBeing(request.getHumanBeing()));
        response = responseCreator.getResponse();
        return response;
    }
    ...
    private Response handleCommandRequest(Request request) throws CommandIsNotExistException {
        ...
        } else if (command.isHumanBeingCommand()) {
            response = responseCreator.getResponse("", ResponseType.HUMAN_BEING_RESPONSE);
        } else {
